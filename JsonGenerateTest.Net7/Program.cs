...
using JsonGenerateTest.Net7;

Console.WriteLine("JSON Serialization Test - .NET 7");
...
{
    Console.WriteLine("✅ No behavioral difference in .NET 7!");
...
else
{
    ...
    Console.WriteLine(reflectionJson.Replace("\r", "").Replace("\n", "").Replace(" ", ""));
    Console.WriteLine();
    Console.WriteLine("Source Generator output:");
    Console.WriteLine(sourceGenJson.Replace("\r", "").Replace("\n", "").Replace(" ", ""));
}
